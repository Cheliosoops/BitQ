...
class SolutionWarp:
    ...
    def fuse_tiles(self, fuse_tile_group=[], erase_tile_list=[]):
        ...
        print('\nbefore int warp', fused_tile_dict)        
        print('after int warp', fused_tile_clone)
        with open("./files_temporary/log.txt","at") as f:
            print('\nbefore int warp', fused_tile_dict,file=f)        
            print('after int warp', fused_tile_clone,file=f)
        ...
        with open("./files_temporary/log.txt","at") as f:
            print('##  degenerate ordered_config  ##',file=f)
    ...
    def tune_parallelism(self, config, sub_pieces, real_plsm):
        ...
        with open("./files_temporary/log.txt","at") as f:
            print('full fork:', full_fork,file=f)
            print('real fork:', real_fork,file=f)
            print('selected p:', min_p,file=f)
        ...
        with open("./files_temporary/log.txt","at") as f:
            print('ideal workload:', ideal_work,file=f)
            print('selected workload', select_work,file=f)
            print('load balance penalty:', select_work/ideal_work,file=f)
        return min_p
